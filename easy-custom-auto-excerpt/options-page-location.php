							...
							<tr valign="top">
								...
								<td colspan="2" class="country">
									<div class="ordinary-select-2">
										...
										<?php post_type_excerpt( 'page_post_type', $options, true, isset( $page_post_type[ $i ] ) ? $page_post_type[ $i ] : false ); ?>
										</select>
									</div>
								</td>
							</tr>
								...
								<td colspan="2">
									<div class="ordinary-select-2">
										<select name="page_category[<?php echo esc_attr( $i ); ?>][]" multiple="multiple" class="page_category_select">
											<?php category_excerpt( 'page_category', $options, true, isset( $page_category[ $i ] ) ? $page_category[ $i ] : false ); ?>
										</select>
									</div>
								</td>
							</tr>
